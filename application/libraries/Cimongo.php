...
class Cimongo extends Cimongo_extras {
        ...
        /**
        * @{Get the documents where the value of a $field is or in a given $in array()}
        * @author lichao
        * @${DATE}
        * @modifier lichao
        * @${DATE}
        ...
        * @ return bool
        */
        public function or_where_in($field = "", $in = array()) {
                $this->_where_init('$or');
                $this->wheres['$or'][][$field]['$in'] = $in;
                return $this;
        }
        /**
        ...
        */
        ...
        {
                $affectinfo=$this->db->command(array('getLastError'=>1));
                return $affectinfo['n'];
        }
